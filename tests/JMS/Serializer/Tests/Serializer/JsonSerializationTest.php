...
class JsonSerializationTest extends BaseSerializationTest
{
    protected function getContent($key)
    {
        ...
        if (!$outputs) {
            ...
            $outputs['chain_default'] = '{"foo":"foo","bar":"bar"}';
            $outputs['chain_default_v1'] = '{"foo":"foo"}';
            $outputs['chain_bar_v2'] = '{"baz":"baz"}';
			...
			$outputs['tree'] = '{"children":[{"children":[{"children":[{"foo":"bar"}],"foo":"bar"}],"foo":"bar"}],"foo":"bar"}';
        }
